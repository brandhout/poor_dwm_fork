...
/*const char *spcmd1[] = {"st", "-n", "spkeepass", "-g", "120x34", NULL };*/
/*const char *spcmd1[] = {"st", "-n", "spkeepass", "-g", "120x34", "-e", "keepassxc", NULL };*/
...
static Key keys[] = {
	...
	{ MODKEY|ShiftMask,		XK_l,		spawn,		SHCMD("xscreensaver-command -lock") },
	...
	{ MODKEY,			XK_d,		spawn,          SHCMD("rofi -theme Pop-Dark -font \"Fira Code 15\" -show drun") },
